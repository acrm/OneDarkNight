...
export const day5Scenes: Scene[] = [
  ...
  },
  {
    ...
    text: [
      ...
      'То, что началось раньше, завершилось этой ночью.',
    ],
  ...
  },
  {
    ...
    text: [
      ...
      'Темнота в доме становится почти осязаемой.',
    ],
    choices: [
  ...
  },
  {
    ...
    choices: [
      { id: 'c1', text: 'Быстро уйти и спрятаться с семьёй', nextSceneId: 'd5_hide_together' },
      {
        ...
        consequenceNote: 'Резкое действие в критический момент стало роковой ошибкой.',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    text: [
      ...
      'Ночь отступила, и дом наконец замолчал.',
      '',
